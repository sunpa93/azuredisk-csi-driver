...
func WaitForAttach(azDiskClient v1alpha1ClientSet.DiskV1alpha1Interface, volumeName string, role v1alpha1.Role, numAttachment int) error {
	...
	conditionFunc := func() (bool, error) {
		...
		if attachmentCount != numAttachment {
			return false, nil
		}
		return true, nil
	}
